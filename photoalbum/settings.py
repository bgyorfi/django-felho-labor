...
SECRET_KEY = 'django-insecure-*(*8$v*ev5chu64^6a^h1(xwcb(_3g&8aol(=j#b+ihc#xpf4h'
...
STATIC_URL = '/static/'
# Gyűjtött statikus fájlok helye (whitenoise innen szolgál ki)
STATIC_ROOT = BASE_DIR / 'staticfiles'
# Whitenoise tároló backend (gzip és cache-elés)
